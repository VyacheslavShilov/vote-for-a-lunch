...
public class Vote {
    ...
    @Id
    @SequenceGenerator(name = "VITES_SEQ", sequenceName = "VITES_SEQ", allocationSize = 1, initialValue = START_VOTE_SEQ)
    //    @Column(name = "id", unique = true, nullable = false, columnDefinition = "integer default nextval('global_seq')")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "VITES_SEQ")
